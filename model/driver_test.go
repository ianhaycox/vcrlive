...
func TestDriver(t *testing.T) {
	t.Run("New drivers should return map", func(t *testing.T) {
		...
		d.SetPositions([]int{0, 2, 1, 3, 4, 0, 0, 0, 0})

		expectedDrivers := Drivers{
			1: Driver{CarIdx: 1, UserName: "Driver 1", ClassPosition: 2},
			2: Driver{CarIdx: 2, UserName: "Driver 2", ClassPosition: 1},
			3: Driver{CarIdx: 3, UserName: "Driver 3", ClassPosition: 3},
			4: Driver{CarIdx: 4, UserName: "Driver 4", ClassPosition: 4},
		}
